        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div>
            <button
              ...
              className="text-zinc-400 hover:text-white flex items-center gap-2 mb-4 transition-colors text-sm"
            >
              ← Kembali ke Jadwal
            </button>
            <h1 className="text-3xl md:text-4xl font-display tracking-tight text-white">Detail Sesi</h1>
          </div>
          ...
          <div className="bg-zinc-900 border border-white/10 rounded-2xl p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div>
                ...
                <p className="text-lg font-medium text-white">{schedule.mataPelajaran}</p>
              </div>
              <div>
                <p className="text-xs font-medium text-zinc-500 mb-1">Kelas</p>
                <p className="text-lg font-medium text-white">{schedule.kelas}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-lg font-medium text-white">{schedule.jamMulai} - {schedule.jamSelesai}</p>
              </div>
            </div>
          </div>
          ...
          {!sessionStarted && (
            <div className="bg-zinc-900 border border-white/10 rounded-2xl p-6">
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <div>
                  <h3 className="text-lg font-medium mb-1 text-white">Mulai Sesi Mengajar</h3>
          ...
          {/* Upload Materi */}
          <div className="bg-zinc-900 border border-white/10 rounded-2xl p-6">
            <h2 className="text-lg font-medium mb-4 text-white">Upload Materi Pembelajaran</h2>
            {uploadError && (
            ...
            <div className="space-y-4">
              <div className="border border-dashed border-white/20 rounded-xl p-6 text-center hover:border-white/30 transition-colors bg-zinc-950/50">
                <input
                  type="file"
                  id="fileUpload"
              ...
              {uploadedFiles.length > 0 && (
                <div className="space-y-3">
                  {uploadedFiles.map((file, idx) => (
                    <div key={file.name + idx} className="p-4 bg-zinc-950 border border-white/5 rounded-xl">
          ...
          {/* Attendance Table */}
          <div className={`bg-zinc-900 border border-white/10 rounded-2xl p-6 ${!sessionStarted ? 'opacity-50 pointer-events-none' : ''}`}>
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-medium text-white">Daftar Kehadiran Siswa</h2>
                      ...
                      <td className="py-4 px-4 text-center">
                        <label className="inline-flex items-center justify-center cursor-pointer">
                          <input
                            ...
                            className="w-4 h-4 rounded border-white/20 bg-zinc-950 checked:bg-emerald-500 checked:border-emerald-500 cursor-pointer transition-all"
                          />
                        </label>
                      </td>
                      <td className="py-4 px-4 text-center">
                        <label className="inline-flex items-center justify-center cursor-pointer">
                          <input
                            ...
                            className="w-4 h-4 rounded border-white/20 bg-zinc-950 checked:bg-amber-500 checked:border-amber-500 cursor-pointer transition-all"
                          />
                        </label>
                      </td>
                      <td className="py-4 px-4 text-center">
                        <label className="inline-flex items-center justify-center cursor-pointer">
                          <input
                            ...
                            className="w-4 h-4 rounded border-white/20 bg-zinc-950 checked:bg-accent-500 checked:border-accent-500 cursor-pointer transition-all"
                          />
                        </label>
                      </td>
                      <td className="py-4 px-4 text-center">
                        <label className="inline-flex items-center justify-center cursor-pointer">
                          <input
                            ...
                            className="w-4 h-4 rounded border-white/20 bg-zinc-950 checked:bg-rose-500 checked:border-rose-500 cursor-pointer transition-all"
                          />
                        </label>
                      </td>
                    </tr>
