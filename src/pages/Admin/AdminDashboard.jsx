    ...
    <div className="bg-zinc-950 min-h-[100dvh] text-white selection:bg-primary-500/30">
      ...
      <main className="px-4 sm:px-6 lg:px-10 pt-12 sm:pt-16 lg:pt-12 pb-12 lg:ml-72">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="rounded-2xl border border-white/10 bg-zinc-900 p-6 sm:p-8 mb-8 flex flex-col lg:flex-row gap-6 items-start lg:items-center lg:justify-between">
            <div>
              <h2 className="text-2xl font-display tracking-tight text-white">Pengawasan Kehadiran Terpusat</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <div className="lg:col-span-3 rounded-2xl bg-primary-500/10 border border-primary-500/20 p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                <h3 className="text-lg font-medium text-white">Rekap Terperinci</h3>
            ...
            <div className="rounded-2xl bg-zinc-900 border border-white/10 p-5 flex flex-col items-start justify-between gap-4 transition-colors hover:border-white/20">
              <div>
                <h3 className="text-lg font-medium text-white">Laporan Bulanan</h3>
                <p className="text-zinc-400 text-sm mt-1">
            ...
            <div className="rounded-2xl bg-zinc-900 border border-white/10 p-5 flex flex-col items-start justify-between gap-4 transition-colors hover:border-white/20">
              <div>
                <h3 className="text-lg font-medium text-white">Manajemen Jadwal</h3>
                <p className="text-zinc-400 text-sm mt-1">
