    ...
    <div className="bg-zinc-950 min-h-[100dvh] text-zinc-50 selection:bg-primary-500/30">
      ...
      <main className="px-4 sm:px-6 lg:px-10 pt-12 sm:pt-16 lg:pt-12 pb-12 lg:ml-72">
        <div className="max-w-5xl mx-auto space-y-6">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
            ...
            <div className="space-y-3">
              {detailPelajaran.materi.map((item) => (
                <div key={item.id} className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-zinc-950 border border-zinc-800 rounded-xl hover:border-zinc-800 transition-colors gap-4">
                  <div className="flex items-start sm:items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-zinc-50 text-sm">{item.judul}</p>
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
            <div className="flex items-center gap-3 mb-4">
              <h3 className="text-lg font-medium text-zinc-50">Video Interaktif</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {detailPelajaran.video.map((item) => (
                <div key={item.id} className="bg-zinc-950 border border-zinc-800 rounded-xl overflow-hidden hover:border-zinc-800 transition-colors cursor-pointer">
          ...
          <div className="bg-primary-600 border border-primary-500 rounded-2xl p-6">
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
              <div>
                <h3 className="text-lg font-medium text-zinc-50">Absensi Kehadiran</h3>
